...
async function getBeers() {
  ...
  function searchBeer() {
    ...
    searchBeer.src = `https://en.wikipedia.org/w/api.php?action=query&list=search&prop=info&inprop=url&utf8=&format=json&srlimit=20&srsearch=ale&callback=wikiSearch&origin=*`;
  ...
  function wikiSearch(data) {
    // console.log(data);
    wikiBeer.innerHTML = `${data.query.search[0].snippet}...\<a class="outside-link" href="https://en.wikipedia.org/wiki/Ale">(read more)</a>`
